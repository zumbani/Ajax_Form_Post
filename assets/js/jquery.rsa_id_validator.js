...
(function($){  
 $.fn.rsa_id_validator = function(options) {  
	...
	var defaults = {  
		displayValid: [true,"<font color='#00CC00'>ID No Valid</font>","<font color='#FF0000'>ID No InValid</font>"],
			...
			function ValidateID(id_number){
				...
				if (id_number.length == 13){ 
					...
					if ((year > 1900) && (year < currentTime.getFullYear())){
						...
						MessageDescriptionArray[MessageDescriptionArray.length] = '';
					}//end if
					...
					if ((month==4 || month==6 || month==9 || month==11) && day==31) {
						...
						MessageDescriptionArray[MessageDescriptionArray.length] = '<br />Date not valid. This month does not have 31 days, ';
					}
					if (month == 2) { // check for february 29th
						...
						if (day > 29 || (day==29 && !isleap)) {
							...
							MessageDescriptionArray[MessageDescriptionArray.length] = '<br />Date not valid. February does not have ' + day + ' days for year ' + year +', ';
						}//end if
					}//end if
					...
					MessageDescriptionArray[MessageDescriptionArray.length] = '<br />ID No is not the right length, ';
				}//end if
